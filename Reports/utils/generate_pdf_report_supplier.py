...
from Transactions.models import Receiving
from Enventory.models import Supplier
...
def generate_pdf_report_supplier(report_data, supplier_id, start_date, end_date):
    buffer = BytesIO()
    ...
    title_text = f"تقرير المورد: {supplier.full_name}"
