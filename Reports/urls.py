...
from .views import inventory_report,inventory_report_item,item_status_report,warehouse_status_report,inventory_report_beneficiary,inventory_report_supplier
...
urlpatterns = [
    ...
    path('inventory_report_supplier/', inventory_report_supplier, name='inventory_report_supplier'),
